...
public class Main {
	...
	public static String benchmarkpath="";
	...
	public static void main(String[] arguments)
	{
		...
		for(int i=2; i < arguments.length; i++) {
			if(i==2) benchmarkpath =  arguments[i];
		...
		/*Not understood this concept of pinpointsprocessing */
	...
	public static void initializeObjectPools() {
		...
		/*Not understood what this pool of instructions serve for */
