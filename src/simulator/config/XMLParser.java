...
public class XMLParser 
{
	...
	private static void setNocProperties(Element NocType, NocConfig nocConfig)
	{
		...
		nocConfig.interChipletLatency = Integer.parseInt(getImmediateString("NocInterChipletLatency", NocType));
		String tempStr = getImmediateString("NocTopology", NocType);
		nocConfig.topology = TOPOLOGY.valueOf(tempStr);
		nocConfig.ischiplet=Boolean.parseBoolean(getImmediateString("IsChiplet", NocType));
